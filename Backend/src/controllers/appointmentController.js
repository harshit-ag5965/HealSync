...
const bookAppointment = async (req, res) => {
  try {
    ...
    // Get patient's email from User collection
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 24px;">
              ...
              <p style="color: #374151;">Your appointment has been booked successfully. Here are the details:</p>
              ...
              <p style="color: #6b7280; font-size: 13px;">Please arrive 10 minutes early. If you need to cancel, please do so at least 24 hours in advance.</p>
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
              ...
              <div style="padding: 24px;">
                ...
                <p style="color: #374151;">Hi <strong>${appointment.patient?.name}</strong>,</p>
                <p style="color: #374151;">Your appointment has been marked as completed. We hope you had a great experience!</p>
                <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
                  ...
                  <tr>
                    <td style="padding: 10px; font-weight: bold; color: #16a34a;">Time</td>
                    <td style="padding: 10px; color: #374151;">${appointment.time}</td>
                  </tr>
                </table>
                <p style="color: #6b7280; font-size: 13px;">Thank you for choosing HMS Hospital. We look forward to serving you again!</p>
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 24px;">
              ...
              <p style="color: #374151;">Hi <strong>${appointment.patient?.name}</strong>,</p>
              <p style="color: #374151;">Your appointment has been cancelled. Here were the details:</p>
              <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
